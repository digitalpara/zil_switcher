...
:START
SRBMiner-CN-Zill.exe --pers auto --kernel 2 --lock_voltage --safe_dag 2 --opencl 0 --templimit 95 --electricity_cost 0.35 --algo etchash --server eu.etchash.k1pool.com:3821 --user KrPiXNVHLJ1rYGb38mEpmd8ewiQo1LFaGTp.01
GOTO START

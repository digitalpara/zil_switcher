...
:START
SRBMiner-CN.exe --send-stale --watchdog-script reboot.bat --progpow-kernel 1 -split-job 6 --strategy 2 --worker 01 --algo sha512256d --watchdog --url stratum+tcp://eu.rxd.vipor.net:5066 --user 13QCij4L5aaHbgx6MqugNijtqCLARuWeGv.01
GOTO START
